    ...
    if ("geolocation" in navigator) {
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          // TODO BACKEND: Enviar coordenadas al servidor
      ...
      <div style={{
        ...
        <motion.div
          ...
          style={{
            ...
            height: '120px',
            borderRadius: '50%',
            background: 'linear-gradient(135deg, #ff1e77 0%, #ff6b3d 100%)',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            marginBottom: '40px',
            boxShadow: '0 20px 40px rgba(255, 30, 119, 0.4)'
          }}
        >
        ...
        >
          <button 
            ...
            style={{
              ...
              borderRadius: '30px',
              border: 'none',
              backgroundImage: loading ? 'linear-gradient(90deg, #999 0%, #666 100%)' : 'linear-gradient(90deg, #ff1e77 0%, #ff6b3d 100%)',
              color: 'white',
              fontWeight: 'bold',
              fontSize: '18px',
